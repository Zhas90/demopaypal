package kz.example.demopaypal.web.rest;

import kz.example.demopaypal.entity.DemoOrder;
import kz.example.demopaypal.service.PaymentService;
...
public class OrderController {
    ...
    @PostMapping
    public String placeOrder(@RequestParam Double totalAmount,
                             HttpServletRequest request) {
        final URI returnUrl = buildReturnUrl(request);
        DemoOrder createdOrder = paymentService.createOrder(totalAmount, returnUrl);
